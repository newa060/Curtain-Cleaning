        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          ...
          <div style="background: #f9fafb; padding: 32px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-size: 13px; color: #6b7280; width: 160px; font-weight: 600;">Full Name</td>
              ...
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-size: 13px; color: #6b7280; font-weight: 600;">Services</td>
                <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-size: 14px; color: #111827;">${servicesList}</td>
              </tr>
              <tr>
                <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-size: 13px; color: #6b7280; font-weight: 600;">Preferred Date</td>
                <td style="padding: 10px 0; border-bottom: 1px solid #e5e7eb; font-size: 14px; color: #111827;">${date || "—"}</td>
              </tr>
              <tr>
                <td style="padding: 10px 0; font-size: 13px; color: #6b7280; font-weight: 600; vertical-align: top;">Notes</td>
                <td style="padding: 10px 0; font-size: 14px; color: #111827; white-space: pre-wrap;">${instructions || "—"}</td>
              </tr>
            </table>
            <div style="margin-top: 24px; padding: 16px; background: #ecfdf5; border-radius: 6px; font-size: 12px; color: #065f46;">
              Reply directly to this email to confirm the booking with ${fullName}.
            </div>
          </div>
        </div>
      `,
